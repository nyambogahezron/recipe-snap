		...
		<div className='flex flex-col items-center justify-start min-h-screen p-4 bg-background text-foreground'>
			...
			<Card className='w-full max-w-md bg-card shadow-md rounded-lg overflow-hidden'>
				<CardHeader className='py-3 px-4'>
					...
					<CardDescription>
						Take a photo of ingredients or a dish to get started.
					</CardDescription>
				</CardHeader>
				<CardContent className='p-4'>
					<div className='flex flex-col gap-4'>
						...
						<label
							...
							className='inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 px-4 py-2 cursor-pointer'
						>
